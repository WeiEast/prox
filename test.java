...
public class One {
     ...
     * @return
     */
    public static PublicKey generateRsaPublicKey(BigInteger modulus, BigInteger publicExponent) throws NoSuchAlgorithmException, InvalidKeySpecException {
...
class Base64Coder {
    ...
    public static void main(String[] args) throws Exception{
        ...
        String modulus = "";
        BigInteger b1 = new BigInteger(modulus, 16);
        BigInteger b2 = new BigInteger(exponent, 16);

        PublicKey publicKey = One.generateRsaPublicKey(b1, b2);
        byte[] tmp =  One.rsaEncrypt("Grx900102,".getBytes(), publicKey);
        String result = Base64Utils.encode(tmp);
